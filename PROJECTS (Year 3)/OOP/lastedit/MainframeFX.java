...
public class MainframeFX extends Application {
    ...
    private MenuBar createMenu() {
        ...
        // Add a new menu item for Reservation
        MenuItem reservationItem = new MenuItem("RESERVATION");
        ...
        // Handle the event for the new Reservation menu item
        reservationItem.setOnAction(e -> new ReservationFX().start(new Stage()));
